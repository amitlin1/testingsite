        ...
        {filters.map((f) => {
          ...
          return (
            <div key={f.key} style={{ position: "relative" }}>
              ...
              {open && (
                <div className="shx-scroll" style={{ position: "absolute", zIndex: 25, top: "calc(100% + 6px)", insetInlineStart: 0, minWidth: "100%", background: "#fff", border: "1px solid #e0e0e0", borderRadius: 12, boxShadow: "rgba(0,0,0,0.12) 0 10px 34px 0", overflow: "hidden", maxHeight: 300, overflowY: "auto", whiteSpace: "nowrap" }}>
